    ...
    <form method="post" action="proses.php?action=update_matkul">
        ...
        <table>
            <tr>
                <td>Kode Matkul</td>
                <td>:</td>
                <td><input type="text" name="kd_matkul" value="<?= $data_matkul['kd_matkul']; ?>" /></td>
            </tr>
            <tr>
                <td>Nama Matkul</td>
                <td>:</td>
                <td><input type="text" name="nama_matkul" value="<?= $data_matkul['nama_matkul']; ?>" /></td>
            </tr>
            <tr>
                <td>Jumlah SKS</td>
                <td>:</td>
                <td><input type="text" name="sks" value="<?= $data_matkul['sks']; ?>" /></td>
            </tr>
            <tr>
                <td>Waktu</td>
                <td>:</td>
                <td><input type="text" name="waktu" value="<?= $data_matkul['waktu']; ?>" /></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
